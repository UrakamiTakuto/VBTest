...
REM OpenCoverを実行
OpenCover.Console.exe -register:Path32 -target:"vstest.console.exe" -targetargs:%TARGET_TEST% -targetdir:%TARGET_TEST_DIR% -filter:%FILTER% -output:"%REPORT_FOLDER%\\%RESULT_FILE%"
